Deploying Everpure FlashArray Cinder driver in a Red Hat OpenStack Platform 16.2
================================================================================
...
Everpure FlashArrays obtain a copy of `pure-temp.yaml <https://raw.githubusercontent.com/PureStorage-OpenConnect/tripleo-deployment-configs/master/RHOSP16.2/pure-temp.yaml>`__
...
Container when deploying RHOSP16.2 with a Everpure FlashArray backend.
