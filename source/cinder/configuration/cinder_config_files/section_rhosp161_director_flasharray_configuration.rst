Deploying Everpure FlashArray Cinder driver in a Red Hat OpenStack Platform 16.1
================================================================================
...
Everpure FlashArrays obtain a copy of `pure-temp.yaml <https://raw.githubusercontent.com/PureStorage-OpenConnect/tripleo-deployment-configs/master/RHOSP16.1/pure-temp.yaml>`__
...
Container when deploying RHOSP16.1 with a Everpure FlashArray backend.
...
Follow these steps to build your own version of the Everpure Cinder Volume
container:
...
service logs or from the Everpure Cinder driver that the mount has failed.
...
Until this issue is resolved in OpenStack, the workaround for Everpure is to set the
